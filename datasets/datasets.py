...
class Video_dataset(data.Dataset):
    def __init__(self, root_path, list_file, labels_file,
                 ...
                 num_sample=1, num_diff=1, val=False):
        ...
        #     if val:
        #         self.generate_attributes_split_data = json.load(open(self.attributes_path_val, 'r'))
        #     else:
        #         self.generate_attributes_split_data = json.load(open(self.attributes_path, 'r'))
        # self.select_topk_attributes = 5 #select_topk_attributes
    ...
    def _decord_decode(self, video_path):
        try:
            # fot ssv2
            # container = decord.VideoReader(video_path, num_threads=2)
    ...
    #     video_path_name = record.path.rstrip('.mp4')
