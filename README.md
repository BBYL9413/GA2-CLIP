...
|----------------------------------------------------------------|:------:|:---------:|:----------:|:----:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [GA2-CLIP](configs/base2novel/finetuning_base2novel/k400)     | 32x224 |   77.0    |    63.3    | 69.5 | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/base2novel/base2novel_K400_log.txt) |

#### HMDB-51
| Name  (configs)                                                | Input  | Base Acc. | Novel Acc. |  HM  |                                                                                                                                                                                                                   Model                                                                                                                                                                                                                   |
|----------------------------------------------------------------|:------:|:---------:|:----------:|:----:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [GA2-CLIP](configs/base2novel/finetuning_base2novel/hmdb)     | 32x224 |   78.3    |    58.9    | 67.2 | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/base2novel/base2novel_HMDB51_log.txt) |

#### UCF-101
| Name  (configs)                                               | Input  | Base Acc. | Novel Acc. |  HM  |                                                                                                                                                                                                                   Model                                                                                                                                                                                                                   |
|---------------------------------------------------------------|:------:|:---------:|:----------:|:----:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [GA2-CLIP](configs/base2novel/finetuning_base2novel/ucf)     | 32x224 |   96.8    |    75.2    | 84.6 | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/base2novel/base2novel_UCF101_log.txt) |

#### SSv2
| Name  (configs)                                                | Input  | Base Acc. | Novel Acc. |  HM  |                                                                                                                                                                                                                   Model                                                                                                                                                                                                                   |
|----------------------------------------------------------------|:------:|:---------:|:----------:|:----:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [GA2-CLIP](configs/base2novel/finetuning_base2novel/ssv2)     | 32x224 |   18.7    |    14.3    | 16.2 | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/base2novel/base2novel_SSv2_log.txt) |
...
|---------------------------------------------------------------------------------------|:-------:|:---------:|:-------|:----------:|:--------------------------------------------------------------------------------------------------------------------------------------------:|
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/hmdb51/16_32_vifi_clip_2_shot.yaml)  | HMDB-51 |     2     | 32x224 |    61.9    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/2_shot_hmdb51_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/hmdb51/16_32_vifi_clip_4_shot.yaml)  | HMDB-51 |     4     | 32x224 |    64.3    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/4_shot_hmdb51_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/hmdb51/16_32_vifi_clip_8_shot.yaml)  | HMDB-51 |     8     | 32x224 |    68.1    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/8_shot_hmdb51_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/hmdb51/16_32_vifi_clip_16_shot.yaml) | HMDB-51 |    16     | 32x224 |    70.8    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/16_shot_hmdb51_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ucf101/16_32_vifi_clip_2_shot.yaml)  | UCF-101 |     2     | 32x224 |    90.0    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/UCF101/2_shot_ucf101_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ucf101/16_32_vifi_clip_4_shot.yaml)  | UCF-101 |     4     | 32x224 |    91.8    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/4_shot_ucf101_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ucf101/16_32_vifi_clip_8_shot.yaml)  | UCF-101 |     8     | 32x224 |    93.8    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/8_shot_ucf101_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ucf101/16_32_vifi_clip_16_shot.yaml) | UCF-101 |    16     | 32x224 |    95.5    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/HMDB51/16_shot_ucf101_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ssv2/16_32_vifi_clip_2_shot.yaml)    |  SSv2   |     2     | 32x224 |    6.8     | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/SSv2/2_shot_ssv2_log.txt)|
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ssv2/16_32_vifi_clip_4_shot.yaml)    |  SSv2   |     4     | 32x224 |    9.9     | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/SSv2/4_shot_ssv2_log.txt) |
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ssv2/16_32_vifi_clip_8_shot.yaml)    |  SSv2   |     8     | 32x224 |    10.6    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/SSv2/8_shot_ssv2_log.txt)|
| [GA2-CLIP](configs/few_shot/finetuning_few_shot/ssv2/16_32_vifi_clip_16_shot.yaml)   |  SSv2   |    16     | 32x224 |    14.7    | [Link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main)/[Log](logs/few_shot/SSv2/16_shot_ssv2_log.txt)|
...
|---------------------------------------------------------------------------|:------:|:-------:|:-------:|:------------:|:--------------------------------------------------------------------------------------------------------------------------------------------:|
| [CLIP image-FT](configs/zero_shot/train/k400/16_16_image_tuned_clip.yaml) | 32x224 |  49.0   |  72.9   |     62.2     | [link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main) |
| [CLIP text-FT](configs/zero_shot/train/k400/16_16_text_tuned_clip.yaml)   | 32x224 |  48.5   |  69.8   |     68.5     | [link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main) |
| [ViFi-CLIP](configs/zero_shot/train/k400/16_16_vifi_clip.yaml)            | 32x224 |  51.3   |  76.8   |     71.2     | [link](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main) |
...
- **For the base2novel experiment on Kinetics-400**
  ...
  ```
  - Step2: Set the generic attribute anchor dataset path, composed of the new K100 dataset. You can build your own suitable dataset or use the examples provided in the [code](datasets_splits/base2novel_splits
/k600_gaa_splits/gaa_splits.txt).
  ```sh
  # For example in config/k400_base2novel:
   gaa_train_root: "gaa/video/" 
   gaa_train_list: "datasets_splits/base2novel_splits/gaa_splits/fs_base_gaa_train.txt"
   gaa_label = "lists/labels/gaa_base_labels_n.csv"
  ```
...
- **For the base2novel experiment on HMDB51/UCF101/SSv2**
  ...
  **Please note that all baseline methods compared load the Vanilla K400 weights during initialization. You may choose your own weights or directly download the [weights](https://huggingface.co/BBLY9413/GA2-CLIP/tree/main) I provide (trained using the original [Text4Vis](https://github.com/whwu95/Text4Vis) code).**
  ...
  ```
  - Step2: Set the generic attribute anchor dataset path, composed of the K400 dataset. You can build your own suitable dataset or use the examples provided in the [code](datasets_splits/base2novel_splits
/k400_gaa_splits/gaa_splits.txt)
  ```sh
  # For example in config/hmdb_base2novel:
   gaa_train_root: "gaa/video/" 
   gaa_train_list: "datasets_splits/base2novel_splits/gaa_splits/fs_base_gaa_train.txt"
  ...
  # For test, you can run:
   bash scripts/run_test.sh  configs/base2novel/hmdb51/hmdb_base2novel_novel_eval.yaml exp_nce/hmdb51/ViT-B/32/last_model.pt
  ```
# ⭐ Citation
